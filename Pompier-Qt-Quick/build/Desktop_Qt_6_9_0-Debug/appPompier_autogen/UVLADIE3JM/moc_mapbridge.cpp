...
void MapBridge::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->pointsReady((*reinterpret_cast< std::add_pointer_t<QVariantList>>(_a[1]))); break;
        case 1: _t->requestPoints(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (MapBridge::*)(const QVariantList & )>(_a, &MapBridge::pointsReady, 0))
            return;
    }
}
...
// SIGNAL 0
void MapBridge::pointsReady(const QVariantList & _t1)
{
