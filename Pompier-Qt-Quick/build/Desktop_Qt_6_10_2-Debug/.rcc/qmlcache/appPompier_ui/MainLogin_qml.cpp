...
0xa8,0x7,0x0,0x0,0xaf,0x21,0x72,0x82,
0x2a,0x84,0x51,0x42,0x92,0xb8,0x80,0x28,
0xc3,0x2a,0xf0,0xe2,0x0,0x0,0x0,0x0,
0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
...
0x2e,0x2,0x18,0x7,0x12,0x17,0x42,0x3,
...
0x6e,0x0,0x20,0x0,0x64,0x0,0x27,0x0,
...
Q_UNUSED(aotContext)
Q_UNUSED(argv)
// onLoginSuccess at line 22, column 9
struct Storage : QQmlPrivate::AOTTrackedLocalsStorage {
Storage(const QQmlPrivate::AOTCompiledContext *ctxt, void **a)   : aotContext(ctxt), argv(a) {}
void markObjects(QV4::MarkStack *markStack) const final {    Q_UNUSED(markStack);
    aotContext->mark(v2_0, markStack);
...
s.v2_4 = QUrl(QStringLiteral("App.qml"));
{
}
// generate_SetLookup
{
...
#endif
while (!aotContext->setObjectLookup(3, s.v2_0, &s.v2_4)) {
#ifdef QT_NO_DEBUG
aotContext->setInstructionPointer(9);
#endif
aotContext->initSetObjectLookup(3, s.v2_0);
if (aotContext->engine->hasError()) {
aotContext->setReturnValueUndefined();
return;
}
